...
import { banBlogInput, blogInput, blogOutput } from "./models/blogs-model";
...
export class BlogsSAController {
    ...
    @HttpCode(HttpStatus.NO_CONTENT)
    @Put(':id/ban')
    async banBlogById(@Param('id') blogId: string,
        ...
        const res = await this.commandBus.execute(new UpdateBanStatusByBlogCommand(blogId, banInput.isBanned))
    }
