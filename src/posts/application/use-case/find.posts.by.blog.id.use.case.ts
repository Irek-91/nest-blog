...
export class FindPostsByBlogIdUseCase implements ICommandHandler<FindPostsByBlogIdCommand> {
constructor (private postQueryRepo: PostQueryRepoPSQL) {

}
    async execute(command: FindPostsByBlogIdCommand): Promise<paginatorPost | null> {
