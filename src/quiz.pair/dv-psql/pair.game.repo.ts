...
export class PairGameRepo {
    ...
    async resultUpdateIsAdraw(pairId: string,
        ...
        try {
            ...
            const updatePairResultPlayerTwo = await this.dataSource.createQueryBuilder()
                .update(Pairresult)
                .set({
            ...
            const updatePairResultPlayerOne = await this.dataSource.createQueryBuilder()
                .update(Pairresult)
                .set({
            ...
            const addAndUpdateStatisticPlayerOne = await this.dataSource.createQueryBuilder()
                .update(Statistic)
                .set({
            ...
            const addAndUpdateStatisticPlayerTwo = await this.dataSource.createQueryBuilder()
                .update(Statistic)
                .set({
