...
export const createBlogByBlogger = async (userId: string, model: blogInput, httpServer: any) => {
    const AccessTokenOne = jwt.sign({ userId: userId }, settings.JWT_SECRET, { expiresIn: 100 })
